...
The examples utilize the \proglang{R} \citep{R2020} package \pkg{spatstat} \citep{spatstat2015} in addition to the \pkg{GET} package \citep{MyllymakiMrkvicka2020}. The plots are produced by the use of the \pkg{ggplot2} package \citep{Wickham2016}.
%
<<r_setup>>=
library("GET")
library("spatstat")
...
%
<<workflow1, fig=TRUE, width=3, height=3>>=
plot(res)
@
%
\end{itemize}
...
%
<<saplings_matclust4, fig=TRUE, width=6, height=3>>=
