...
vignette: >
  %\VignetteIndexEntry{Point patterns}
...
These examples utilize the R [@R2020] package spatstat [@spatstat2015] in addition to the GET package [@MyllymakiMrkvicka2019].
```{r setup}
library("GET")
library("spatstat")
```
