...
#' The main motivation for this package are the scalings for deviation tests and new exact
#' envelope tests.
#'
#'
...
#' Envelope tests:
#' \itemize{
#'   \item \code{\link{rank_envelope}}, completely non-parametric rank envelope test
#'   \item \code{\link{st_envelope}}, a semiparametric envelope test, protected against unequal variance of T(r) for different distances r
#'   \item \code{\link{qdir_envelope}}, a semiparametric envelope test, protected against unequal variance and asymmetry of T(r) for different distances r
...
#' quantile envelope tests, it is nsim=999. 
